...
resource "helm_release" "gpu_provisioner" {
  ...
  depends_on = [helm_release.istio_base, helm_release.istiod, helm_release.body_based_router]
}
...
resource "helm_release" "kaito_workspace" {
  ...
  depends_on = [helm_release.gpu_provisioner]
}
...
resource "helm_release" "kaito_ragengine" {
  ...
  depends_on = [helm_release.kaito_workspace]
}
